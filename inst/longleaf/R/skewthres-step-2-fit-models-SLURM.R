...
slurm_out       <- paste0(args$sim_dir, "/slurm/skewthres-step-2-", args$logs_suffix)
models_dir      <- paste0(args$sim_dir, "/skewthres-models")
logs_dir        <- paste0(args$sim_dir, "/logs/skewthres-step-2-", args$logs_suffix)
...
code_to_run <- paste(args$code_dir, "skewthres-step-2-fit-models.R", sep = "/")
run_cmd <- paste("
# Command to run 
