...
slurm_out       <- paste0(args$sim_dir, "/slurm/skewthres-step-1")
models_dir      <- paste0(args$sim_dir, "/skewthres-models")
logs_dir        <- paste0(args$sim_dir, "/logs/skewthres-step-1")
...
code_to_run <- paste(args$code_dir, "skewthres-step-1-create-data.R", sep = "/")
run_cmd <- paste("
# Command to run 
