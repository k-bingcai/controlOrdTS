...
slurm_out       <- paste0(args$sim_dir, "/slurm/step-3-", args$logs_suffix)
models_dir      <- paste0(args$sim_dir, "/models")
logs_dir        <- paste0(args$sim_dir, "/logs/step-3-", args$logs_suffix)
...
code_to_run <- paste(args$code_dir, "step-3-extract-results-omitvar.R", sep = "/")
run_cmd <- paste("
# Command to run 
